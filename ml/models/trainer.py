...
from ml.features.extractor import BEHAVIORAL_FEATURES, GRAPH_FEATURES, TEMPORAL_FEATURES, ALL_FEATURES
...
class ModelTrainer:
    ...
    def train_all(
        ...
        print(f"Training 4 model variants on {len(df_train):,} training records (Positives: {df_train['label'].sum():,})...")

        # 1. Behavioral Baseline
        print("  [1/4] Training Behavioral Baseline Model...")
        ...
        print("  [2/4] Training Graph-Enhanced Model...")
        ...
        print("  [3/4] Training Temporal-Enhanced Model...")
        ...
        # 4. Full Sentinel Model
        print("  [4/4] Training Full Sentinel Model...")
